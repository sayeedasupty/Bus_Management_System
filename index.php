...
<div id="wrapper">
    ...
    <div id="featured">
        <div id="items">
            ...
            <div class="item"> 
					<a href="lodging.php"><img src="xres/images/02_featured.jpg" alt="" /></a>
				<h3><a href="lodging.php">New Route</a></h3>
				<p><a href="lodging.php"><strong>From Dhaka to Sylhet Vice versa</strong><br />
					Share your experience with us. </a></p>  
			</div>
		</div>
    </div>
