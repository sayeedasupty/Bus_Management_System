		...
		<div id="panel-outer" class="radius" style="opacity: 1;">
			<div id="panel" class="radius">
							...
							while($row = mysql_fetch_array($result))
								{
									...
									echo '<td><div align="left">'.$row['route'].'</div></td>';
									echo '<td><div align="left">'.$row['numseats'].'</div></td>';
									echo '<td><div align="right">'.$row['price'].'</div></td>';
									echo '<td><div align="left">'.$row['time'].'</div></td>';
									echo '<td><div align="center"><a rel="facebox" href="editrutedetails.php?id='.$row['id'].'">edit</a> | 
				...
				<div id="footer" class="radius-bottom">
					2015 ©
					<a class="afooter-link" href="">Simoom Bus Ticketing System</a>
					by
					<a class="afooter-link" href="">Simoom</a>
				</div>
				<div class="clearfix"></div>
			</div>
			<div class="clearfix"></div>
