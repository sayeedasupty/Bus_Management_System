								...
								while($row = mysql_fetch_array($result))
									{
										...
										while($rows = mysql_fetch_array($results))
											{
												echo '<td><div align="left">'.$rows['route'].'</div></td>';
												echo '<td><div align="left">'.$rows['type'].'</div></td>';
												echo '<td><div align="left">'.$rows['time'].'</div></td>';
											}
										$resulta = mysql_query("SELECT * FROM reserve WHERE transactionnum='$dddd'");
										while($rowa = mysql_fetch_array($resulta))
											{
												echo '<td><div align="left">'.$rowa['seat'].'</div></td>';
											}
